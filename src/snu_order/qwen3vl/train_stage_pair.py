...
def _make_dataloaders(
    ...
    valid_loader = DataLoader(valid_dataset, batch_size=1, shuffle=False, collate_fn=Qwen3VLSingleFrameCollator(processor), num_workers=0) if ddp.is_main else None
